...
getVisibility = useGame #visibility
...
-- askRunner :: forall l cn r ph pl i es. (GameInteract l cn r ph pl i :> es) => Eff es (PlayRunner l cn r ph pl i)
-- askRunner = do
--   GameInteract (Game _ pr _ _) <- getStaticRep @(GameInteract l cn r ph pl i)
--   return pr

-- getRunner :: forall l cn r ph pl i es. (GameInteract l cn r ph pl i :> es) => Eff es (PlayRunner l cn r ph pl i)
-- getRunner = do
--   GameInteract (Game _ pr _ _) <- getStaticRep @(GameInteract l cn r ph pl i)
--   return pr

-- modifyGameState :: forall l cn r ph pl i es. (GameInteract l cn r ph pl i :> es) => (GameState l cn r ph pl i -> GameState l cn r ph pl i) -> Eff es ()
-- modifyGameState f = do
--   GameInteract (Game gs gr vis setup) <- getStaticRep @(GameInteract l cn r ph pl i)
...
-- modifyVisibility :: forall l cn r ph pl i es. (GameInteract l cn r ph pl i :> es) => (VisibilityMap l cn ->  VisibilityMap l cn) -> Eff es ()
...
-- assignVisibility :: (GameInteract l cn r ph pl i :> es) => ASetter (VisibilityMap l cn) (VisibilityMap l cn) a b -> b -> Eff es ()
